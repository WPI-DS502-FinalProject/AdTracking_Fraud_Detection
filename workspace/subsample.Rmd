...
for (c in 2:100){
  ...
  ones_1 <- ones[sample(nrow(ones)), ]
  ones_1 <- ones_1[sample(100000), ]
  ...
  write.csv(combined, file = sprintf("data/t1p60_subsamples/sub_%s.csv", c),row.names=FALSE, col.names = FALSE)
}
```